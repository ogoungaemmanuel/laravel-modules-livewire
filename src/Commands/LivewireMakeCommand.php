...
namespace xslain\LaravelModulesLivewire\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\File;
use xslain\LaravelModulesLivewire\Traits\ComponentParser;

class LivewireMakeCommand extends Command
{
    use ComponentParser;

    protected $signature = 'pagemodule:make-livewire {component} {module} {--view=} {--force} {--inline} {--stub=} {--custom}';
